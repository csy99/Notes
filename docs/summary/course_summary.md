...
Info Sys 371: 第一门专业课。之前没上过专业课前其实对这个专业的概念很模糊，在上完这门专业课之后对这个专业变得更加迷惑了。老师有时候加一节课讲编程风格、网络安全、区块链。主要任务是学C\#。不过我还是挺混的，很多C\#独有的特点掌握的不是很好。期末领导一个小组做了一个简易的小游戏Lights Out，还是挺有成就感的。链接是https://github.com/csy99/LightsOut。需要到LightsOut/bin/Release/文件夹中下载可执行文件。有兴趣的同学可以玩一下，有什么好的建议欢迎跟我提。因为比较仓促，还有很多功能有待实现。另外我其实不是很懂玩这个游戏，在这个页面有一个java文件使用Chase Lights策略完成的计算最优步骤的程序（实际上就是bits manipulation），但是我的确不太理解他的逻辑（代码逻辑来源于谷歌），所以没有把他写入我的程序中。要是哪位大神明白这个逻辑也请赐教。
