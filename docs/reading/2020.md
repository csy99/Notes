...
@Cole Knaflic  
	...
	6 key step to present our data:
		...
		6. tell a story
	First, distinguish between exploratory analysis and explanatory analysis. Focus on the latter one. 
To better achieve this goal, there are three main elements: target audience, main contents, and ways to present.
Being able to tell the story concisely is the key, and a storyboard can be helpful for brainstorming and collecting thoughts.
